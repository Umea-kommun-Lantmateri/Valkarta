...
declare module ol {
    ...
    module Collection {
        ...
        class Event extends ol.events.Event {
             ...
             * @implements {oli.Collection.Event}
             * @param {Collection.EventType} type Type.
             * @param {*=} opt_element Element.
             */
    ...
    /**
     * An {@link ColorLike} can be a color, gradient or pattern accepted by
     * [CanvasRenderingContext2D.fillStyle](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/fillStyle).
     * @namespace colorlike
     */
    module colorlike {
        /**
         * @param {Color|ColorLike} color Color.
         * @return {ColorLike} The color as an ol.ColorLike
         * @api
         */
    ...
    module control {
         ...
         * * {@link control.Zoom}
         * * {@link control.Rotate}
         * * {@link control.Attribution}
         *
         * @param {olx.control.DefaultsOptions=} opt_options Defaults options.
         * @return {Collection.<control.Control>} Controls.
         * @api stable
         */
        ...
        class MousePosition extends ol.control.Control {
             ...
             * undefined.
             * @return {CoordinateFormatType|undefined} The format to render the current
             *     position in.
             * @observable
             * @api stable
             */
             ...
             * @return {proj.Projection|undefined} The projection to report mouse
             *     position in.
             * @observable
             * @api stable
             */
             ...
             * @param {CoordinateFormatType} format The format to render the current
             *     position in.
             * @observable
             * @api stable
             */
             ...
             * @param {proj.Projection} projection The projection to report mouse
             *     position in.
             * @observable
             * @api stable
             */
        ...
        class ScaleLine extends ol.control.Control {
             ...
             * @return {control.ScaleLine.Units|undefined} The units to use in the scale
             *     line.
             * @observable
             * @api stable
             */
    ...
    class Feature extends ol.Object {
         ...
         * @observable
         */
        getStyle(): (style.Style | style.Style[] | FeatureStyleFunction | StyleFunction);
         ...
         * @observable
         */
        setStyle(style: (style.Style | style.Style[] | FeatureStyleFunction | StyleFunction)): void;
    ...
    module format {
        ...
        class EsriJSON extends ol.format.JSONFeature {
             ...
             * @function
             * @param {ArrayBuffer|Document|Node|Object|string} source Source.
             * @return {proj.Projection} Projection.
             * @api
             */
             ...
             *
             * @function
             * @param {geom.Geometry} geometry Geometry.
        ...
        module filter {
             ...
             *
             * @param {...format.filter.Filter} conditions Filter conditions.
             * @returns {!format.filter.Or} `<Or>` operator.
             * @api
             */
            function or(...conditions: format.filter.Filter[]): format.filter.Or;

            /**
             * Create a logical `<And>` operator between two or more filter conditions.
             *
             * @param {...format.filter.Filter} conditions Filter conditions.
             * @returns {!format.filter.And} `<And>` operator.
             * @api
             */
            function and(...conditions: format.filter.Filter[]): format.filter.And;

            /**
             * Represents a logical `<Not>` operator for a filter condition.
             *
             * @param {!format.filter.Filter} condition Filter condition.
             * @returns {!format.filter.Not} `<Not>` operator.
             * @api
             */
            function not(condition: format.filter.Filter): format.filter.Not;
             ...
             * @param {string=} opt_srsName SRS name. No srsName attribute will be
             *    set on geometries when this is not provided.
             * @returns {!format.filter.Bbox} `<BBOX>` operator.
             * @api
             */
            function bbox(geometryName: string, extent: Extent, opt_srsName?: string): format.filter.Bbox;
             ...
             * @param {string=} opt_srsName SRS name. No srsName attribute will be
             *    set on geometries when this is not provided.
             * @returns {!format.filter.Within} `<Within>` operator.
             * @api
             */
            function within(geometryName: string, geometry: geom.Geometry, opt_srsName?: string): format.filter.Within;
             ...
             * @returns {!format.filter.EqualTo} `<PropertyIsEqualTo>` operator.
             * @api
             */
            function equalTo(propertyName: string, expression: string | number, opt_matchCase?: boolean): format.filter.EqualTo;
             ...
             * @param {!(string|number)} expression The value to compare.
             * @param {boolean=} opt_matchCase Case-sensitive?
             * @returns {!format.filter.NotEqualTo} `<PropertyIsNotEqualTo>` operator.
             * @api
             */
            function notEqualTo(propertyName: string, expression: string | number, opt_matchCase?: boolean): format.filter.NotEqualTo;
             ...
             * @returns {!format.filter.LessThan} `<PropertyIsLessThan>` operator.
             * @api
             */
            function lessThan(propertyName: string, expression: number): format.filter.LessThan;
             ...
             * @param {!string} propertyName Name of the context property to compare.
             * @param {!number} expression The value to compare.
             * @returns {!format.filter.LessThanOrEqualTo} `<PropertyIsLessThanOrEqualTo>` operator.
             * @api
             */
            function lessThanOrEqualTo(propertyName: string, expression: number): format.filter.LessThanOrEqualTo;
             ...
             * @param {!string} propertyName Name of the context property to compare.
             * @param {!number} expression The value to compare.
             * @returns {!format.filter.GreaterThan} `<PropertyIsGreaterThan>` operator.
             * @api
             */
            function greaterThan(propertyName: string, expression: number): format.filter.GreaterThan;
             ...
             * @param {!string} propertyName Name of the context property to compare.
             * @param {!number} expression The value to compare.
             * @returns {!format.filter.GreaterThanOrEqualTo} `<PropertyIsGreaterThanOrEqualTo>` operator.
             * @api
             */
            function greaterThanOrEqualTo(propertyName: string, expression: number): format.filter.GreaterThanOrEqualTo;
             ...
             *
             * @param {!string} propertyName Name of the context property to compare.
             * @returns {!format.filter.IsNull} `<PropertyIsNull>` operator.
             * @api
             */
            function isNull(propertyName: string): format.filter.IsNull;
             ...
             * @returns {!format.filter.IsBetween} `<PropertyIsBetween>` operator.
             * @api
             */
            function between(propertyName: string, lowerBoundary: number, upperBoundary: number): format.filter.IsBetween;
             ...
             * @param {boolean=} opt_matchCase Case-sensitive?
             * @returns {!format.filter.IsLike} `<PropertyIsLike>` operator.
             * @api
             */
            function like(propertyName: string, pattern: string, opt_wildCard?: string, opt_singleChar?: string, opt_escapeChar?: string, opt_matchCase?: boolean): format.filter.IsLike;
             ...
             * @returns {!format.filter.During} `<During>` operator.
             * @api
             */
            function during(propertyName: string, begin: string, end: string): format.filter.During;
            ...
            class And extends ol.format.filter.LogicalNary {
                 ...
                 * @api
                 */
                constructor(...conditions: format.filter.Filter[]);
            }
            ...
            class Not extends ol.format.filter.Filter {
                 ...
                 * @api
                 */
                constructor(condition: format.filter.Filter);
            }
        ...
        class WFS extends ol.format.XMLFeature {
             ...
             *
             * @param {Document|Node|Object|string} source Source.
             * @return {WFSTransactionResponse|undefined} Transaction response.
             * @api stable
             */
             ...
             *
             * @param {Document|Node|Object|string} source Source.
             * @return {WFSFeatureCollectionMetadata|undefined}
    ...
    module geom {
        ...
        class LineString extends ol.geom.SimpleGeometry {
             ...
             * @api
             */
            forEachSegment<T, S>(callback: ((this: S, start: Coordinate, end: Coordinate) => T), opt_this?: S): (T | boolean);
    ...
    module interaction {
        ...
        module DragAndDrop {
            ...
            class Event extends ol.events.Event {
                 ...
                 * @type {proj.Projection|undefined}
                 * @api
                 */
        ...
        class Draw extends ol.interaction.Pointer {
             ...
             * @return {DrawGeometryFunctionType} Function that draws a box-shaped polygon.
             * @api
             */
            static createBox(): DrawGeometryFunctionType;
    ...
    class Map extends ol.Object {
        ...
        getFeaturesAtPixel(
            pixel: Pixel,
            opt_options?: olx.AtPixelOptions
        ): (Array<Feature | render.Feature> | null);
    ...
    module proj {
        ...
        class Projection {
             ...
             * @param {function(number, Coordinate):number} func Function
             * @api
             */
    ...
    module source {
        ...
        class ImageWMS extends ol.source.Image {
            ...
            /**
             * Return the image load function of the source.
             * @return {ImageLoadFunctionType} The image load function.
             * @api
             */
            getImageLoadFunction(): ImageLoadFunctionType;
